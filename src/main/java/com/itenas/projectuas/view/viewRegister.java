...
public class viewRegister extends javax.swing.JFrame {
    ...
    private byte[] readImageFile(File file) {
        // membaca konten dari file gambar yang diberikan (parameter File file) dan mengonversinya menjadi array byte 
        try (FileInputStream fis = new FileInputStream(file)) {
            ByteArrayOutputStream bos = new ByteArrayOutputStream(); // digunakan untuk menampung data byte dari file gambar.
            byte[] buf = new byte[1024]; // Membuat array byte dengan ukuran 1024 byte. Ini digunakan sebagai buffer untuk membaca data dari file.
